...
<div class="woocommerce_account_subscriptions">
	...
	<?php else : ?>
		...
		<p class="no_subscriptions"><?php printf( __( 'You don\'t have any active membership. Head over to the %smembership page%s to get one.', 'woocommerce-subscriptions' ), '<a href="' . mongabay_url('membership') . '">', '</a>' ); ?></p>
